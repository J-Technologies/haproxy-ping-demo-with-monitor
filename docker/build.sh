...
docker build -t robbertvdzon/monitor ./monitor
docker run -d -it -p 1287:8787 -p 1290:9990 -p 172.17.42.1:38080:8080 -p 1288:8080 --name monitor --link haproxy:haproxy robbertvdzon/monitor
